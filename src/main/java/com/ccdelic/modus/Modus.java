...
public class Modus {
    ...
    public Modus(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modContainer.registerConfig(ModConfig.Type.COMMON, StructureRarityMenuMarker.SPEC, CONFIG_FOLDER + "/structureOptions/rarityMenu.toml");
        modContainer.registerConfig(ModConfig.Type.COMMON, ModdedOreMenuMarker.SPEC, CONFIG_FOLDER + "/oreOptions/moddedOreMenu.toml");
