 ...
 * default behavior unchanged. Extends {@link ModusSectionScreen} rather than NeoForge's stock
 * {@code ConfigurationSectionScreen} directly so this section's own Reset button (for
 * "enabled") gets the same reset-confirmation prompt every other Modus config screen does.
 */
public class BlacklistSectionScreen extends ModusSectionScreen {
