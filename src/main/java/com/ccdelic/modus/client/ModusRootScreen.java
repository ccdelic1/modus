 ...
 * built for it - {@link ModusSectionScreen} for the two remaining plain {@code ModConfigSpec}
 * pages (XP Settings, Biome Size), {@link BlacklistSectionScreen} for the structure block
 * blacklist, and
...
public class ModusRootScreen extends OptionsSubScreen {
    ...
    protected void addOptions() {
        ...
        addConfigSectionButton(
            "modus.configuration.section.modus.biomesize.biomesize.toml",
            BiomeSizeConfig.SPEC,
            (modConfig, title) -> new ModusSectionScreen(this, ModConfig.Type.COMMON, modConfig, title)
        );
        addConfigSectionButton(
