 ...
 * <ul>
 *   <li>not a managed modded ore - place normally (the overwhelmingly common case, gated
 *   behind a cheap {@link ModdedOreRegistry#hasAny()} check so non-modpack worlds and every
 *   non-ore feature pay almost nothing).</li>
